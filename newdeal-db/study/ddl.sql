...
CREATE TABLE nd_stud (
	...
	det_addr VARCHAR(255) NULL     COMMENT '주소번호' -- 주소번호
)
COMMENT '수강생';
...
CREATE TABLE nd_addr (
	ano      VARCHAR(255) NOT NULL COMMENT '주소번호', -- 주소번호
...
ALTER TABLE nd_addr
	MODIFY COLUMN ano VARCHAR(255) NOT NULL AUTO_INCREMENT COMMENT '주소번호';
