...
//    같아야 한다.
// => 인터페이스의 매서드 이름, 파라미터, 리턴 타입이 
//    SQL매퍼의 아이디, 파라미터, 리턴 타입이 같아야 한다. 
@MapperScan("com.eomcs.lms.dao")
public class AppConfig {

  // Sprnig IoC Container가 로딩한 프로퍼티 정보를 가져오기
  // => "야! Sprnig IoC Container. 로딩한 프로퍼티 값 중에서
  //    jdbc.driver라는 이름을 가진 값을 꺼내
  //    jdbcDriver 변수에 넣어줘!
  @Value("${jdbc.driver}")
  String jdbcDriver;
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // Domain 클래스에(VO; Value Object)의 별명 자동 생성하기
    factoryBean.setTypeAliasesPackage("com.eomcs.lms.domain");

    // SQL 매퍼 파일 로딩
    // => SQL 매퍼 파일의 위치정보를 Resource 객체에 담아서 넘겨야 한다.
    // => Resource 객체는 Sprnig IoC Container를 통해 만들 수 있다.
    // => Sprnig IoC Container 객체를 얻는 방법
